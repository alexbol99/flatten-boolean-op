...
function arrange(polygon1, polygon2)
{
    ...
    splitByIntersections(polygon1, intersections.int_points1_sorted);
    splitByIntersections(polygon2, intersections.int_points2_sorted);
}
